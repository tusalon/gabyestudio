...
const urlsToCache = [
  ...
  '/gabyestudio/utils/push-config.js',
  '/gabyestudio/utils/push-notifications.js'
];
...
self.addEventListener('push', event => {
  ...
  const options = {
    ...
    icon: '/gabyestudio/icons/icon-192x192.png',
    badge: '/gabyestudio/icons/icon-96x96.png',
    tag: payload.tag || 'rservasroma',
    data: {
      url: payload.url || '/gabyestudio/admin.html',
      ...(payload.data || {})
    }
  };
...
self.addEventListener('notificationclick', event => {
  ...
  const targetUrl = event.notification?.data?.url || '/gabyestudio/admin.html';
  event.waitUntil(
